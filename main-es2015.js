...
let CourseListComponent = class CourseListComponent {
    constructor(coursesService, filterPipe, router) {
...
let NewCourseComponent = class NewCourseComponent {
    constructor(router, route, coursesService) {
        this.router = router;
        this.route = route;
        this.coursesService = coursesService;
    }
    ngOnInit() {
        ...
        this.route.paramMap
            ...
            return params.get('id') ? this.coursesService.getCourse(+params.get('id')) : Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["of"])(null);
        }))
            .subscribe(() => (this.courseItems = Object.assign({}, this.courseItems)), err => console.log(err));
    }
    onCancelClick() {
        this.onGoBack();
    }
    onSaveClick() {
        const courseItems = Object.assign({}, this.courseItems);
...
let BreadcrumbsComponent = class BreadcrumbsComponent {
    ...
    ngOnInit() {
        this.url = '';
        this.router.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["filter"])(event => event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_3__["NavigationStart"])).subscribe((event) => {
